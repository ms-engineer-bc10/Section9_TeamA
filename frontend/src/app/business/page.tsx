...
//   const yellowButtonStyle = "bg-yellow-500 hover:bg-yellow-400 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 transform hover:scale-105 text-lg";
...
//               <button className={yellowButtonStyle}>
//                 詳しくはこちら
//               </button>
//             </Link>
